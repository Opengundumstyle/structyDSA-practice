...
# money stashed. All houses at this place are arranged in a circle. That means the first house is the neighbor of the last one. 
...
class Solution:
    ...
    def helper(self,num: List[int]) -> int:
         rob1,rob2 = 0,0
         for el in num:
              maxTemp = max(rob1+el,rob2)
              rob1 = rob2
              rob2 = maxTemp
         return rob2
