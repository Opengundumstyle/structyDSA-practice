...
const allTreePaths = (root) => {
    // todo
     ...
     let leftVals = allTreePaths(root.left)
     for(let subPath of leftVals){
          result.push([root.val,...subPath])
     }
     let rightVals = allTreePaths(root.right)
     for(let subPath of rightVals){
          result.push([root.val,...subPath])
     }
     return result;
  };
