...
let leftPathNums = pathFinderHelper(root.left,target)
 if(leftPathNums !== null){
     leftPathNums.push(root.val)
     return leftPathNums
}
let rightPathNums = pathFinderHelper(root.right,target)
 if(rightPathNums !== null){
     rightPathNums.push(root.val)
     return rightPathNums
}
 return null
};
